...
![Bet 1: physics-level content properties add predictive value beyond semantic-level properties. Left side shows semantic-only model (Vc) with moderate fit. Right side shows semantic plus physics model (Vc + V0/V1/V2) with improved fit. The delta-R-squared between the two determines success or failure.](/images/ch11/ch11_img11_bet1_physics_value.webp)
