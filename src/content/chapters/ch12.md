...
![Dual-use framework diagram showing one toolkit with constructive and destructive application arrows](/images/ch12/ch12_img01_chapter_opener.png)
...
![Conditional framing diagram showing three bets gating all applications](/images/ch12/ch12_img02_conditional_framing.png)
...
![Creator workflow pipeline from raw video through physics decomposition, cortical prediction, mutation, publish, to causal graph](/images/ch12/ch12_img03_creator_workflow.png)
...
![Split-panel comparison of two educational video variants showing different cortical activation patterns](/images/ch12/ch12_img04_education_application.png)
...
![Public health campaign optimization flowchart showing variant testing funnel and per-persona effect sizes](/images/ch12/ch12_img05_public_health.png)
...
![Journalist's diagnostic workflow showing cortical prediction from video rough cut, DMN versus ventral attention comparison, and causal graph accumulation](/images/ch12/ch12_img11_journalism_diagnostic.png)
...
![Therapy content design panel showing cortical activation goals, controlled mutation test, and behavioral proxy results](/images/ch12/ch12_img12_therapy_wellbeing.png)
...
![Artist's perceptual instrument workflow showing cortical activation map, variant grid, and mutation legend for creative exploration](/images/ch12/ch12_img13_art_perceptual_instrument.png)
...
![Research methodology pipeline showing base videos, single-variable mutation, cortical prediction and behavioral measurement tracks, and causal dataset](/images/ch12/ch12_img14_research_tool.png)
...
![Warning diagram showing how the same mutation engine enables addiction engineering with persona targeting](/images/ch12/ch12_img06_addiction_engineering.png)
...
![Warning diagram showing political manipulation via physics-level optimization with per-persona targeting of persuadable segments](/images/ch12/ch12_img15_political_manipulation.png)
...
![Warning diagram showing children's content exploitation through salience capture optimization versus suppressed narrative engagement](/images/ch12/ch12_img16_children_exploitation.png)
...
![Split warning diagram showing financial exploitation through deliberation-gap compression and deepfake enhancement through perceptual incongruity reduction](/images/ch12/ch12_img17_financial_deepfake.png)
...
![Warning diagram showing corporate manipulation of employee personas through per-cluster optimization of compliance and advocacy outcomes](/images/ch12/ch12_img18_corporate_manipulation.png)
...
![Mirror diagram showing good-intention and bad-intention applications sharing identical mechanisms](/images/ch12/ch12_img07_dual_use_table.png)
...
![Three-panel illustration showing masked effects, inefficient optimization, and false nulls from collapsing across personas](/images/ch12/ch12_img08_persona_dependency.png)
...
![Ethical neutrality diagram showing thermometer analogy, three observations, and balance of democratization versus proliferation](/images/ch12/ch12_img09_ethical_neutrality.png)
...
![Decision tree showing conditional outcomes depending on which bets hold or fail](/images/ch12/ch12_img10_speculation_boundary.png)
...
![Structured summary matrix of good-intention applications showing key vectors, bet dependencies, and evidence grades per application](/images/ch12/ch12_img19_summary_table.png)
...
![Closing summary showing seven constructive and six destructive applications sharing every mechanism, with no application demonstrated as of April 2026](/images/ch12/ch12_img20_conclusion_boundary.png)
