...
![The fourteen mutation operators organized into four categories. V0-targeted (physics): luminance grade, audio gain, audio EQ, time stretch, crop/scale. V1-targeted (temporal): retime, reorder. Vc-targeted, V0-touching (cognitive trigger): face area (crop and inpaint), swap asset, replace caption. Extended: transition change, spatial placement, audio pan.](/images/ch07/ch07_img04_operator_vocabulary.webp)
...
![Sample size calculation for mutation experiments. Locked parameters: alpha = 0.05 (two-sided), power = 0.80, MDE = 5% relative shift. At baseline completion rate 0.40, the two-proportion z-test yields approximately 9,400 observations per arm. With DEFF = 1.5 for clustered observations (Kish 1965): 1x1 design requires approximately 19,000 total observations, 1xk dose-response 28,000-38,000, 2x2 factorial approximately 38,000. Persona-specific multiplier M_P/share_P is TBD until Phase 9, provisional value 2.0.](/images/ch07/ch07_img14_sample_size_calculation.webp)
