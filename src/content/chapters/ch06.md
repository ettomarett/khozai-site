...
![Paired measurement: content-side vectors (V0 through Vn) describe what the video is; behavioral-side measurements (Vp platform metrics and self-report outputs) describe what happened after publication. The publish event separates the two sides.](/images/ch06/ch06_img01_chapter_opener.webp)
...
![Four sampling checkpoints after publication: 1 hour, 24 hours, 7 days, and 28 days. The 28-day value is the canonical Vp for correlation analysis. Each checkpoint records metrics separately for each platform (TikTok, Reels, Shorts).](/images/ch06/ch06_img03_four_checkpoints.webp)
...
![The five behavioral families of Vp, organized as a funnel: Selection (did the viewer start?), Retention (did they keep watching?), Active Engagement (did they act beyond watching?), Distribution (did they pass it on?), and Context (under what conditions was it published?). Fewer viewers progress to each deeper stage.](/images/ch06/ch06_img02_vp_behavioral_funnel.webp)
...
![Active engagement family (5 metrics) arranged by increasing motor effort: vp_like_count (tap), vp_comment_count (type), vp_save_count (future-directed), vp_share_count (redistribute), and vp_engagement_rate (rollup of all four). The engagement_rate rollup hides which type drove the rate - use components for correlation analysis.](/images/ch06/ch06_img12_active_engagement_detail.webp)
...
![Self-report as a bridge between Experience Space and Behavioral Output Space. The motor act of typing a comment lives in Behavioral Output Space; the experience the words refer to lives in Experience Space. Self-report is the only channel that touches both spaces.](/images/ch06/ch06_img06_self_report_bridge.webp)
